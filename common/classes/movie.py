...
class Movie:
    ...
    def log_movie_info(self) -> None:
        ...
        countries = [country.name for country in self.production_countries] if self.production_countries else []
        overview_short = (self.overview[:75] + "...") if self.overview and len(self.overview) > 75 else (self.overview or "")
